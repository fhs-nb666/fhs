...
static rosidl_typesupport_introspection_c__MessageMember robot_interfaces__srv__SetMode_Request__rosidl_typesupport_introspection_c__SetMode_Request_message_member_array[1] = {
  {
    "mode",  // name
    ...
    offsetof(robot_interfaces__srv__SetMode_Request, mode),  // bytes offset in struct
    NULL,  // default value
...
static rosidl_typesupport_introspection_c__MessageMember robot_interfaces__srv__SetMode_Response__rosidl_typesupport_introspection_c__SetMode_Response_message_member_array[1] = {
  {
    "success",  // name
