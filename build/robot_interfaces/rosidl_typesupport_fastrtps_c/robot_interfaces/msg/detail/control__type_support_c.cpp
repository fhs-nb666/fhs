...
#include "robot_interfaces/msg/detail/control__rosidl_typesupport_fastrtps_c.h"
...
using _Control__ros_msg_type = robot_interfaces__msg__Control;
...
size_t get_serialized_size_robot_interfaces__msg__Control(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Control__ros_msg_type * ros_message = static_cast<const _Control__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Control__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_interfaces__msg__Control(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_interfaces
size_t max_serialized_size_robot_interfaces__msg__Control(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces__msg__Control;
    is_plain =
      (
...
static size_t _Control__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_interfaces__msg__Control(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_interfaces, msg, Control)() {
