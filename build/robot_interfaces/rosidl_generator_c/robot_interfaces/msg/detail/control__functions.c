...
robot_interfaces__msg__Control__init(robot_interfaces__msg__Control * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    robot_interfaces__msg__Control__fini(msg);
    return false;
  }
  // angle
  // fire
...
robot_interfaces__msg__Control__create()
{
  ...
  robot_interfaces__msg__Control * msg = (robot_interfaces__msg__Control *)allocator.allocate(sizeof(robot_interfaces__msg__Control), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robot_interfaces__msg__Control));
  bool success = robot_interfaces__msg__Control__init(msg);
  if (!success) {
...
robot_interfaces__msg__Control__Sequence__init(robot_interfaces__msg__Control__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_interfaces__msg__Control * data = NULL;

  if (size) {
    data = (robot_interfaces__msg__Control *)allocator.zero_allocate(size, sizeof(robot_interfaces__msg__Control), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robot_interfaces__msg__Control__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        robot_interfaces__msg__Control__fini(&data[i - 1]);
      }
...
robot_interfaces__msg__Control__Sequence__fini(robot_interfaces__msg__Control__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      robot_interfaces__msg__Control__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_interfaces__msg__Control__Sequence * array = (robot_interfaces__msg__Control__Sequence *)allocator.allocate(sizeof(robot_interfaces__msg__Control__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robot_interfaces__msg__Control__Sequence__init(array, size);
  if (!success) {
...
robot_interfaces__msg__Control__Sequence__destroy(robot_interfaces__msg__Control__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robot_interfaces__msg__Control__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robot_interfaces__msg__Control__Sequence__are_equal(const robot_interfaces__msg__Control__Sequence * lhs, const robot_interfaces__msg__Control__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robot_interfaces__msg__Control__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robot_interfaces__msg__Control__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robot_interfaces__msg__Control);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robot_interfaces__msg__Control * data =
      (robot_interfaces__msg__Control *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robot_interfaces__msg__Control__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robot_interfaces__msg__Control__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!robot_interfaces__msg__Control__copy(
