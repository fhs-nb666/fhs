...
bool robot_interfaces__msg__target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_interfaces.msg._target.Target", full_classname_dest, 35) == 0);
  }
  robot_interfaces__msg__Target * ros_message = _ros_message;
  {  // header
...
PyObject * robot_interfaces__msg__target__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_interfaces.msg._target");
