...
#include "robot_solver/srv/detail/set_mode__rosidl_typesupport_fastrtps_c.h"
...
#include "robot_solver/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _SetMode_Request__ros_msg_type = robot_solver__srv__SetMode_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_solver
size_t get_serialized_size_robot_solver__srv__SetMode_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetMode_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_solver__srv__SetMode_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_solver
size_t max_serialized_size_robot_solver__srv__SetMode_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_solver__srv__SetMode_Request;
    is_plain =
      (
...
static size_t _SetMode_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_solver__srv__SetMode_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_solver, srv, SetMode_Request)() {
...
using _SetMode_Response__ros_msg_type = robot_solver__srv__SetMode_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_solver
size_t get_serialized_size_robot_solver__srv__SetMode_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetMode_Response__ros_msg_type * ros_message = static_cast<const _SetMode_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_solver__srv__SetMode_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_solver
size_t max_serialized_size_robot_solver__srv__SetMode_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_solver__srv__SetMode_Response;
    is_plain =
      (
...
static size_t _SetMode_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_solver__srv__SetMode_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_solver, srv, SetMode_Response)() {
...
// already included above
// #include "robot_solver/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "robot_solver/srv/set_mode.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_solver, srv, SetMode)() {
